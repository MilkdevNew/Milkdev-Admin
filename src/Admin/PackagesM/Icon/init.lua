...
function Icon:_updateIconSize(_, iconState)
	...
	local labelWidth =
		textService:GetTextSize(iconContentText, labelHeight, values.iconFont, Vector2.new(10000, labelHeight)).X
...
function Icon:_updateCaptionSize()
	...
	if iconSize and labelFont then
		...
		if isVisible then
			...
			captionContainer.Size =
				UDim2.new(0, textWidth + CAPTION_X_MARGIN * 2, 0, cellHeight * CAPTION_CONTAINER_Y_SIZE_SCALE)
		else
